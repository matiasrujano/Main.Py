...
if (confirmation == "no") or (confirmation == "No"):
    ...
    print('\n'"Awesome!""\n""Question #01""\n" + name,
          ",what is the result for the fallowing operation?""\n""11+22+33+44+55+66+77+88+99")
...
if userInput8 == question8:
    print("Congratulations you are correct!")
elif (userInput8 <= 3) and (userInput8 >= 2) or (userInput8 >= 0) and (
        userInput8 < 1):
    print("You were close, but the correct answer is", question8, end="!"'\n')
else:
    print("Your answer was incorrect! The correct answer is", question8,
          end="!"'\n')
print('\n'"Question #09"'\n' + name,
      ",From the image below, how many squares individual and grouped can you identify?"'\n')
for row in range(4):
...
if userInput9 == question9:
    ...
    print("Your answer was incorrect! The correct answer is", question9,
          end="!"'\n')
print('\n'"Question #10"'\n' + name,
...
if userInput10 == question10:
    ...
    print("Your answer was incorrect! The correct answer is", question10,
          end="!"'\n')
print('\n'"Question #11"'\n' + name,
...
if userInput11 == question11:
    print("Congratulations you are correct!")
elif (userInput11 <= 7) and (userInput11 >= 6) or (userInput11 <= 3) and (
        userInput11 <= 4):
    print("You were close, but the correct answer is", question11, end="!"'\n')
else:
    print("Your answer was incorrect! The correct answer is", question11,
          end="!"'\n')
...
def main():
    ...
    answer12 = diameter_circle(radius)  # call to diameter_circle
